...
import com.mikufans.manage.util.ValidateUtil;
...
public class UserController
{
                                   ...
                                   UserSearchDTO userSearch)
    {
        ...
        pageDataResult = userService.getUser(userSearch, page, limit);
        logger.debug("用户列表查询=pageDataResult：" + pageDataResult);
            ...
            @RequestParam(value = "rememberMe", required = false) boolean rememberMe)
    {
        ...
        Cache<String, AtomicInteger> passwordRetryCache = ehCacheManager
